...
StudentArrayBean SABean= relation.StudentDisplay();
%>
<div class="demo">

 <select  id="class" name="pulldown1" class="validate[required]" ">
<option value="">ページを選んでください</option>
  <option value="0">S1A1</option>
  <option value="1">S2A1</option>
  ...
  <table border="1">
<tr><th>生徒ID</th><th>名前</th></tr>
<%
ArrayList<StudentBean> SA=SABean.getStudentArray();
for(StudentBean sBean : SA){
	%>
 <tr>
    <td><%= sBean.getStudent_id() %></td>
    <td><%= sBean.getStudent_name()%></td>
